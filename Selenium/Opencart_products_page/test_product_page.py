...
@pytest.mark.usefixtures("driver", "open_login_page", "login_action", "open_products_page", "edit_product")
def test_edit_product(products_list):
    """Test that New product is edited"""
    assert "Edited Product" in products_list


@pytest.mark.usefixtures("driver", "open_login_page", "login_action", "open_products_page", "delete_product")
